...
// var flag =  check.childNodes[1]
// console.log(flag.hasAttribute('aria-disabled'))
// checked = () =>{
//     if (flag.hasAttribute('aria-disabled') !=true){
//     check.innerHTML=`<i class="fa fa-check-circle-o icon-color fa-big" aria-disabled="false" aria-hidden="true"></i>`
//     text.innerHTML =  `<del>${text.innerHTML}</del>`
//     }
//     else if ((flag.hasAttribute('aria-disabled') ==true)) {
//         check.innerHTML=`<i  class="fa fa-circle-thin fa-big" aria-hidden="true"></i>  `
